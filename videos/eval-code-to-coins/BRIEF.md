...
ゲーム側が反応し、主人公 (白いウサギ) の周りにコインが湧き出して着地する。
...
外部素材なし。すべてコード/CSS/SVG で作画 (`asset_needs: []`)。
Bunny Blitz 画面は実画面キャプチャではなく**模式図**でという指定 —
フラットな板状のプラットフォーム、簡略化したウサギのグリフ、簡易 HUD。

## Customizations

- パレットは Bunny Blitz のロゴ/アートから採取: 紫 #4B1E9E / 青 #1E9BF0 /
  黄 #FFC824 / ゴールド #E8A317 / 白ウサギ + ピンクの前髪 #FF2D96 + シアンの目 #35D3F5
